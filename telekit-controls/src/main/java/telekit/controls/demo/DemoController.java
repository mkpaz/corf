...
import telekit.controls.widgets.ContextMenuPolicy;
import telekit.controls.widgets.richtextfx.RichTextFXContextMenu;
import telekit.controls.widgets.richtextfx.RichTextFXHelper;

import java.time.LocalDate;
import java.util.*;
import java.util.stream.Collectors;

@FxmlPath("/telekit/controls/demo/root.fxml")
public class DemoController implements Component {
